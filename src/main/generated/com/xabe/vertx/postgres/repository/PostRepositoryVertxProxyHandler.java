...
public class PostRepositoryVertxProxyHandler extends ProxyHandler {
  ...
  public PostRepositoryVertxProxyHandler(Vertx vertx, PostRepository service){
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public PostRepositoryVertxProxyHandler(Vertx vertx, PostRepository service, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond);
  }

  public PostRepositoryVertxProxyHandler(Vertx vertx, PostRepository service, boolean topLevel, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond, false);
  }

  public PostRepositoryVertxProxyHandler(Vertx vertx, PostRepository service, boolean topLevel, long timeoutSeconds, boolean includeDebugInfo) {
      this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "save": {
          service.save(json.getJsonObject("data") != null ? new com.xabe.vertx.postgres.repository.data.Post((JsonObject)json.getJsonObject("data")) : null,
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "update": {
          service.update(json.getJsonObject("data") != null ? new com.xabe.vertx.postgres.repository.data.Post((JsonObject)json.getJsonObject("data")) : null,
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "deleteAll": {
