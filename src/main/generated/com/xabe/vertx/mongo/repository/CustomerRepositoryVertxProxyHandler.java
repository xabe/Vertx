  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "save": {
          service.save(json.getJsonObject("customer") != null ? new com.xabe.vertx.mongo.repository.data.Customer((JsonObject)json.getJsonObject("customer")) : null,
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "update": {
          service.update(json.getJsonObject("customer") != null ? new com.xabe.vertx.mongo.repository.data.Customer((JsonObject)json.getJsonObject("customer")) : null,
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "deleteAll": {
